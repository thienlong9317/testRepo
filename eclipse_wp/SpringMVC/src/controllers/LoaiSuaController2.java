...
@Controller
@RequestMapping("/loaisua2")
public class LoaiSuaController2 {
...
//	}
	...
	@RequestMapping(path = "/them", method = RequestMethod.POST)
	public String them(LoaiSua ls, Model model) 
	{
//		String maLoai,tenLoai;
//		maLoai = request.getParameter("txtMaLoai");
//		tenLoai = request.getParameter("txtTenLoai");
...
//		ls.setTenLoai(tenLoai);
		...
		LoaiSuaBL.them(ls);
		model.addAttribute("maLoai", ls.getMaLoai());
		model.addAttribute("tenLoai", ls.getTenLoai());
		return "them-loai-sua2";
	}
}