            ...
            <div class="col-md-9">
                <div class="row">
                    <div class="container m-5">
                        <h3><?php echo 'chao cac ban php'; ?></h3>
                        <form>
            ...
            <div class="row">
                <div class="col-md-4 border">
                    <ul class="colfoot">
                        ...
                        <li><a href="/chinh-sach-bao-hanh-san-pham" title="Chính sách đổi trả">Chính sách đổi trả</a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-4 border">
                    <ul class="colfoot">
                        <li><a href="http://mwg.vn" target="_blank" title="Giới thiệu công ty (mwg.vn)"
                                rel="noopener">Giới
                                thiệu công ty <span>(mwg.vn)</span></a></li>
                        <li><a href="//vieclam.thegioididong.com" target="_blank" title="Tuyển dụng"
                                rel="noopener">Tuyển
                                dụng</a></li>
